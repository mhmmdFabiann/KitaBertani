...
class HomeUserWidget extends StatefulWidget {
  ...
  final DocumentReference? petaniID;
...
class _HomeUserWidgetState extends State<HomeUserWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PanganRecord>>(
      stream: queryPanganRecord(
        queryBuilder: (panganRecord) => panganRecord.where(
          'userID',
      ...
      builder: (context, snapshot) {
        ...
        List<PanganRecord> homeUserPanganRecordList = snapshot.data!;
                              ...
                              child: Container(
                                ...
                                child: StreamBuilder<List<PanganRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<PanganRecord>
                                        listViewPanganRecordList =
                                        snapshot.data!;
                                    return ListView.builder(
                                      padding: EdgeInsets.zero,
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewPanganRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewPanganRecord =
                                            listViewPanganRecordList[
                                                listViewIndex];
                                        return Container(
                                          width: 100.0,
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            context.pushNamed('tambahProduk');
                                          },
                                          text: 'Tambah Produk',
